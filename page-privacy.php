<?php /* Template Name: プライバシーポリシー */ get_header(); ?>
<main>
  <div id="js-main">
    <div class="l-main">
      <div class="p-privacy">
        <section>
          <div class="p-privacy__heading">
            <h2 class="c-title" data-ja="プライバシーポリシー"><span class="c-title--red">PRIVCY&nbsp;POLICY</span></h2>
          </div>
        </section>
        <div class="p-privacy__content">
          <div class="p-privacy-block">
            <div class="p-privacy-block__child">
              <h3>プライバシーポリシーの宣言</h3>
              <p>当社の運営するウェブサイトをご利用いただくお客様のプライバシーの保護に努めています。</p>
              <p>当社がサービスを提供するためには、お客様個人に関する情報（以下、「個人情報」といいます）を集めなければなりませんが、当社でその情報のプライバシーを守り、秘密を保持するために様々な手段を講じています。</p>
            ...
            <div class="p-privacy-block__child">
              <h3>個人情報の管理</h3>
              <p>お客様の個人情報は、当社が適切な管理を行なうとともに、漏洩、滅失、毀損の防止のために最大限の注意を払っております。尚、当社ではお客様によりよいサービスを提供するため、個人情報を適切に取り扱っていると認められる外部の委託先に、個人情報の取り扱いの一部を委託しています。委託先は、委託業務を行なうために必要な範囲で個人情報を利用します。</p>
              <p>
            ...
            <div class="p-privacy-block__child">
              <h3>従業員の監督方法</h3>
              <p>個人情報保護の重要性について、適時または定期的に適切な教育を行っております。</p>
              <p>また、当社が個人情報を管理する際は、管理責任者を置き適切な管理を行うとともに、外部への流出防止に努めます。</p>
              <p>
                さらに、外部からの不正アクセスや改ざん等の危険に対しては、適切かつ合理的な範囲の安全対策を実施し、お客様の個人情報保護に努めます。
              </p>
              <p>個人情報に係るデータベース等のアクセスについては、アクセス権を有するものを限定し、社内においても不正な利用がなされないように厳重に管理します。</p>
            </div>
            <div class="p-privacy-block__child">
              <h3>リンク先</h3>
            ...
            <div class="p-privacy-block__child">
              <h3>プライバシーポリシーの改訂</h3>
              <p>当社では、お客様に提供するサービス向上のため、上記各項目の内容を適宜見直し、改善してまいります。本書を変更する場合は、この変更について本ウェブサイトに掲載します。</p>
