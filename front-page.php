            ...
            <div class="p-home-shop">
              ...
              <div class="p-home-shop__main">
                ...
                <div class="p-home-shop__desc">
                  <?php // 【一時変更 2026-08】デンタル便24 一時休止のお知らせ。復帰時は下の __notice を削除し、元の __detail のコメントを解除してください。 ?>
                  <?php /*
                  ...
                  */ ?>
                  <div class="p-home-shop__notice">
                    <p><strong>平素は【デンタル便24】をご利用いただき、誠にありがとうございます。</strong></p>
                    <p>この度、お客様の利便性向上とセキュリティ強化を目的とした、システムメンテナンスを実施いたします。<br>つきましては、誠に勝手ながら暫くの間、”デンタル便24”の全サービスを一時休止させていただきます。</p>
                    <p>お客様にはご不便とご迷惑をおかけいたしますが、何卒ご理解とご協力を賜りますようお願い申し上げます。</p>
                  </div>
                </div>
              </div>
