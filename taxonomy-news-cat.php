    ...
    <div class="p-news">
      ...
      <div class="p-news__content">
        <ul class="p-news__cats">
          ...
          <?php $taxonomy_terms = get_terms('news-cat', [
            'hide_empty' => false,
            'orderby' => 'description',
          ]);
          if (!empty($taxonomy_terms) && !is_wp_error($taxonomy_terms)) {
            foreach ($taxonomy_terms as $taxonomy_term) : ?>
              <li class="u-tab_btn <?php if ($taxonomy_term->slug === $term) {
                                      echo 'active';
                                    } ?>"><a href="<?php echo get_term_link($taxonomy_term); ?>"><?php echo $taxonomy_term->name; ?></a></li>
          <?php endforeach;
          }
          ?>
        </ul>
          ...
          <article>
            <div class="p-mews-article">
              <ul class="p-mews-article__list">
                ...
                $type = get_query_var('news-cat'); //指定したいタクソノミーを指定
                $args = array(
                  'post_type' => array('news'), /* 投稿タイプを指定 */
                  'tax_query' => array(
                    'relation' => 'OR',
                    array(
                      'taxonomy' => 'news-cat', /* 指定したい投稿タイプが持つタクソノミーを指定 */
                      'field' => 'slug',
                ...
                <?php if ($my_query->have_posts()) : ?>
                  <?php while ($my_query->have_posts()) : $my_query->the_post(); /* ループ開始 */ ?>
